...
function addFooter(){
  ...
  footer.innerHTML=''
    ...
    +'<div class="ew-footer-grid"><div class="ew-footer-col"><h3>Navigation</h3><a href="./index.html">Accueil</a><a href="./cv.html">CV</a><a href="#devis" id="ewFooterDevis">Vos informations</a><a href="./a-propos.html">À propos</a><a href="./faq.html">FAQ</a></div><div class="ew-footer-col"><h3>Services</h3><a href="./cv.html#formules">CV Starter</a><a href="./cv.html#formules">CV Boost</a><a href="./cv.html#formules">CV Premium</a><a href="./cv.html#formules">Lettre de motivation</a></div><div class="ew-footer-col"><h3>Contact</h3><a href="mailto:contact@eternaweb.fr">✉ contact@eternaweb.fr</a><a href="https://wa.me/33749723434" target="_blank" rel="noopener">💬 WhatsApp</a><a href="./avis.html">⭐ Avis</a></div></div>'
