...
(function(){
  ...
  var CV = {
    fr:{
      ...
      p1:'📝 Pack Starter – 9,99 €', p1a:'Correction orthographique et grammaticale', p1b:'Mise en page simple et structurée (Word/PDF)', p1n:'👉 Idéal pour stage, job étudiant ou premier emploi',
    ...
    en:{
      ...
      pricing:'💼 CV Packages', pricingSub:'Professional CV solutions tailored to your needs.', p1:'📝 Starter Package – €9.99', p1a:'Spelling and grammar correction', p1b:'Simple, structured layout (Word/PDF)', p1n:'👉 Ideal for internships, student jobs or a first job',
    ...
    de:{
      ...
      pricing:'💼 CV-Pakete', pricingSub:'Professionelle CV-Lösungen, passend zu Ihren Bedürfnissen.', p1:'📝 Starter-Paket – 9,99 €', p1a:'Rechtschreib- und Grammatikprüfung', p1b:'Einfache und strukturierte Gestaltung (Word/PDF)', p1n:'👉 Ideal für Praktikum, Studentenjob oder Berufseinstieg',
    ...
    it:{
      ...
      pricing:'💼 Pacchetti CV', pricingSub:'Soluzioni professionali per il CV, adattate alle tue esigenze.', p1:'📝 Pacchetto Starter – 9,99 €', p1a:'Correzione ortografica e grammaticale', p1b:'Impaginazione semplice e strutturata (Word/PDF)', p1n:'👉 Ideale per stage, lavoro studentesco o primo impiego',
    ...
    es:{
      ...
      pricing:'💼 Planes de CV', pricingSub:'Soluciones profesionales de CV, adaptadas a tus necesidades.', p1:'📝 Pack Starter – 9,99 €', p1a:'Corrección ortográfica y gramatical', p1b:'Diseño sencillo y estructurado (Word/PDF)', p1n:'👉 Ideal para prácticas, trabajo estudiantil o primer empleo',
    ...
    ru:{
      ...
      pricing:'💼 Пакеты резюме', pricingSub:'Профессиональные решения для резюме, адаптированные под ваши потребности.', p1:'📝 Пакет Starter – 9,99 €', p1a:'Орфографическая и грамматическая проверка', p1b:'Простое структурированное оформление (Word/PDF)', p1n:'👉 Идеально для стажировки, студенческой работы или первой работы',
    ...
    et:{
      ...
      pricing:'💼 CV-paketid', pricingSub:'Professionaalsed CV-lahendused, mis on kohandatud sinu vajadustele.', p1:'📝 Starter-pakett – 9,99 €', p1a:'Õigekirja- ja grammatikakontroll', p1b:'Lihtne ja struktureeritud kujundus (Word/PDF)', p1n:'👉 Ideaalne praktikaks, üliõpilastööks või esimeseks töökohaks',
