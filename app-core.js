...
const COMMON = {
  fr: {
    ...
    'devis.h2':'📝 Vos informations','devis.sub':'Choisissez, décrivez, envoyez — je reçois vos consignes.',
    'devis.colors':'Palette / couleurs','devis.colorsPlaceholder':'Ex. beige & doré, brun café…','devis.style1':'Sobre & élégant','devis.style2':'Créatif & coloré','devis.style3':'Minimal & pro','devis.style4':'Nature & doux',
