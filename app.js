...
'brief.h2':'Your site in 3 steps','brief.li1':'Choose a plan.','brief.li2':'Share your preferences (colors, style, integrations).','brief.li3':'I create and send you a mockup.',
'btn.fill':'Your brief','btn.send':'Send','btn.choose':'I choose this plan',
'devis.h2':'📝 Your brief','devis.sub':'Choose, describe, send — I receive your instructions.','devis.type':'Site type','devis.colors':'Palette / colors','devis.style':'Visual style',
'devis.style1':'Sober & elegant','devis.style2':'Creative & colorful','devis.style3':'Minimal & pro','devis.style4':'Nature & soft',
'devis.integrations':'Desired integrations','devis.int.form':'Contact form','devis.int.social':'Social networks','devis.int.gallery':'Gallery',
'devis.other':'Other requests','devis.name':'First / Last name','devis.email':'Email','devis.note':'No server: your email app opens with a pre-filled message.','devis.opt.cv':'CV','devis.opt.vitrine':'Showcase','devis.opt.portfolio':'Portfolio','devis.opt.other':'Other',
'models.h2':'🎨 Ready-made templates','models.sub':'Pick a style, open the demo, and tell me which one you want.','models.demo':'View template',
'models.cv.title':'CV — clean & pro','models.cv.desc':'Great for job applications.','models.port.title':'Portfolio — creative','models.port.desc':'Perfect for artists & designers.','models.vit.title':'Showcase — business','models.vit.desc':'For businesses & freelancers.',
'pricing.h2':'🧾 EternaWeb plans','pricing.sub':'CV & mini showcase sites — hosting included',
'pricing.card1.title':'🌿 Essential Pack – €49','pricing.card1.li1':'Simple online CV (1 page)','pricing.card1.li2':'Personalization with info + photo','pricing.card1.li3':'Elegant & responsive design','pricing.card1.li4':'Delivery within 48h','pricing.card1.note':'Ideal for: job applications',
'pricing.card2.title':'✨ Showcase Pack – €89','pricing.card2.li1':'Mini showcase site (2–3 pages)','pricing.card2.li2':'Home + products/services presentation','pricing.card2.li3':'WhatsApp, PayPal, social buttons','pricing.card2.li4':'Harmonious & responsive design','pricing.card2.note':'Ideal for: artisans, freelancers',
'pricing.card3.title':'💎 Premium Pack – €129','pricing.card3.li1':'Everything in Showcase Pack','pricing.card3.li2':'Logo creation/redesign','pricing.card3.li3':'Branding advice','pricing.card3.li4':'Basic SEO + Gallery/FAQ','pricing.card3.note':'Ideal for: full launch',
'testi.h2':'💬 Testimonials','testi.t1':'“Super responsive and professional, my site was online the same day!”','testi.c1':'— Claire B.','testi.t2':'“Elegant, clear design, and most importantly… clients contact me directly via WhatsApp!”','testi.c2':'— Malik T.','testi.t3':'“Excellent value for money. Highly recommended.”','testi.c3':'— Sofia M.',
'footer.info':'Useful info','footer.contact':'Contact','footer.about':'About','footer.security':'Security','footer.privacy':'Privacy','footer.code':'Code of conduct','footer.faq':'FAQ'
  ...
  nl: {
    'nav.menu':'Menu','nav.cv':'CV','nav.portfolio':'Portfolio','nav.vitrine':'Vitrinesite','nav.tarifs':'Prijzen','nav.devis':'Uw instructies','nav.temoignages':'Getuigenissen','nav.modeles':'Templates',
...
'brief.h2':'Uw site in 3 stappen','brief.li1':'Kies een pakket.','brief.li2':'Geef uw voorkeuren door (kleuren, stijl, integraties).','brief.li3':'Ik maak een ontwerp en stuur het u.',
'btn.fill':'Uw instructies','btn.send':'Verzenden','btn.choose':'Ik kies dit pakket',
...
'devis.style1':'Eenvoudig & elegant','devis.style2':'Creatief & kleurrijk','devis.style3':'Minimalistisch & professioneel','devis.style4':'Natuurlijk & zacht',
'devis.integrations':'Gewenste integraties','devis.int.form':'Contactformulier','devis.int.social':'Sociale netwerken','devis.int.gallery':'Galerij',
'devis.other':'Andere verzoeken','devis.name':'Voornaam / Achternaam','devis.email':'E-mail','devis.note':'Geen server: uw e-mailapp opent met een vooraf ingevuld bericht.','devis.opt.cv':'CV','devis.opt.vitrine':'Vitrine','devis.opt.portfolio':'Portfolio','devis.opt.other':'Andere',
'models.h2':'🎨 Beschikbare templates','models.sub':'Kies een stijl, open de demo en vertel me welke u wilt.','models.demo':'Bekijk template',
'models.cv.title':'CV — netjes & pro','models.cv.desc':'Ideaal voor sollicitaties.','models.port.title':'Portfolio — creatief','models.port.desc':'Perfect voor artiesten & ontwerpers.','models.vit.title':'Vitrine — zakelijk','models.vit.desc':'Voor bedrijven & freelancers.',
'pricing.h2':'🧾 EternaWeb pakketten','pricing.sub':'CV & mini-vitrinesites — hosting inbegrepen',
'pricing.card1.title':'🌿 Essentieel – €49','pricing.card1.li1':'Eenvoudig online CV (1 pagina)','pricing.card1.li2':'Personalisatie met info + foto','pricing.card1.li3':'Elegant & responsive ontwerp','pricing.card1.li4':'Levering binnen 48u','pricing.card1.note':'Ideaal voor: sollicitaties',
'pricing.card2.title':'✨ Vitrine – €89','pricing.card2.li1':'Mini-vitrinesite (2–3 pagina’s)','pricing.card2.li2':'Home + presentatie producten/diensten','pricing.card2.li3':'WhatsApp, PayPal, sociale knoppen','pricing.card2.li4':'Harmonieus & responsive ontwerp','pricing.card2.note':'Ideaal voor: ambachtslieden, freelancers',
'pricing.card3.title':'💎 Premium – €129','pricing.card3.li1':'Alles uit Vitrine','pricing.card3.li2':'Logo creatie/herontwerp','pricing.card3.li3':'Brandingadvies','pricing.card3.li4':'Basis SEO + Galerie/FAQ','pricing.card3.note':'Ideaal voor: volledige lancering',
'testi.h2':'💬 Getuigenissen','testi.t1':'“Super responsief en professioneel, mijn site stond dezelfde dag online!”','testi.c1':'— Claire B.','testi.t2':'“Elegant, duidelijk ontwerp… klanten schrijven me direct via WhatsApp!”','testi.c2':'— Malik T.','testi.t3':'“Uitstekende prijs-kwaliteitverhouding. 100% aanbevolen.”','testi.c3':'— Sofia M.',
...
'brief.h2':'Ваш сайт в 3 шага','brief.li1':'Выберите пакет.','brief.li2':'Укажите предпочтения (цвета, стиль, интеграции).','brief.li3':'Я сделаю макет и пришлю вам.',
...
'devis.style1':'Сдержанный и элегантный','devis.style2':'Креативный и яркий','devis.style3':'Минималистичный & профессиональный','devis.style4':'Природный и мягкий',
...
'devis.other':'Другие пожелания','devis.name':'Имя / Фамилия','devis.email':'Email','devis.note':'Без сервера: ваше почтовое приложение откроется с заполненным письмом.','devis.opt.cv':'Резюме','devis.opt.vitrine':'Витрина','devis.opt.portfolio':'Портфолио','devis.opt.other':'Другое',
...
'models.cv.title':'Резюме — строго & проф','models.cv.desc':'Идеально для откликов на вакансии.','models.port.title':'Портфолио — креатив','models.port.desc':'Идеально для художников и дизайнеров.','models.vit.title':'Витрина — бизнес','models.vit.desc':'Для компаний и фрилансеров.',
...
'pricing.card3.title':'💎 Premium – 129 €','pricing.card3.li1':'Всё из тарифа Витрина','pricing.card3.li2':'Создание/редизайн логотипа','pricing.card3.li3':'Консультация по брендингу','pricing.card3.li4':'Базовое SEO + Галерея/FAQ','pricing.card3.note':'Идеально для полного запуска',
...
'brief.h2':'Ihre Website in 3 Schritten','brief.li1':'Wählen Sie ein Paket.','brief.li2':'Teilen Sie Ihre Präferenzen (Farben, Stil, Integrationen).','brief.li3':'Ich erstelle und sende ein Mockup.',
'btn.fill':'Ihr Briefing','btn.send':'Senden','btn.choose':'Dieses Paket wählen',
'devis.h2':'📝 Ihr Briefing','devis.sub':'Wählen, beschreiben, senden — ich erhalte Ihre Angaben.','devis.type':'Seitentyp','devis.colors':'Palette / Farben','devis.style':'Visueller Stil',
...
'devis.integrations':'Gewünschte Integrationen','devis.int.form':'Kontaktformular','devis.int.social':'Soziale Netzwerke','devis.int.gallery':'Galerie',
'devis.other':'Weitere Wünsche','devis.name':'Vorname / Nachname','devis.email':'E-Mail','devis.note':'Kein Server: Ihre Mail-App öffnet sich mit einer ausgefüllten Nachricht.','devis.opt.cv':'Lebenslauf','devis.opt.vitrine':'Schaufenster','devis.opt.portfolio':'Portfolio','devis.opt.other':'Andere',
...
'models.cv.title':'Lebenslauf — schlicht & pro','models.cv.desc':'Ideal für Bewerbungen.','models.port.title':'Portfolio — kreativ','models.port.desc':'Perfekt für Künstler & Designer.','models.vit.title':'Schaufenster — Business','models.vit.desc':'Für Unternehmen & Freiberufler.',
'pricing.h2':'🧾 EternaWeb-Pakete','pricing.sub':'Lebenslauf & Mini-Schaufensterseiten — Hosting inklusive',
'pricing.card1.title':'🌿 Essenziell – 49 €','pricing.card1.li1':'Einfacher Online-Lebenslauf (1 Seite)','pricing.card1.li2':'Personalisierung mit Daten + Foto','pricing.card1.li3':'Elegantes & responsives Design','pricing.card1.li4':'Lieferung in 48 Std.','pricing.card1.note':'Ideal für: Bewerbungen',
'pricing.card2.title':'✨ Schaufenster – 89 €','pricing.card2.li1':'Mini-Schaufensterseite (2–3 Seiten)','pricing.card2.li2':'Startseite + Produkte/Dienstleistungen','pricing.card2.li3':'WhatsApp, PayPal, Social Buttons','pricing.card2.li4':'Harmonisches & responsives Design','pricing.card2.note':'Ideal für: Handwerker, Freiberufler',
'pricing.card3.title':'💎 Premium – 129 €','pricing.card3.li1':'Alles aus Schaufenster','pricing.card3.li2':'Logo-Erstellung/Redesign','pricing.card3.li3':'Branding-Beratung','pricing.card3.li4':'Basis-SEO + Galerie/FAQ','pricing.card3.note':'Ideal für: vollständigen Launch',
...
'btn.fill':'Sus indicaciones','btn.send':'Enviar','btn.choose':'Elijo este plan',
...
'devis.style1':'Sobrio & elegante','devis.style2':'Creativo & colorido','devis.style3':'Minimal & profesional','devis.style4':'Natural & suave',
...
'devis.other':'Otras solicitudes','devis.name':'Nombre y apellidos','devis.email':'Email','devis.note':'Sin servidor: tu app de correo se abrirá con un mensaje pre-rellenado.','devis.opt.cv':'CV','devis.opt.vitrine':'Escaparate','devis.opt.portfolio':'Portafolio','devis.opt.other':'Otro',
'models.h2':'🎨 Plantillas listas','models.sub':'Elige un estilo, abre la demo y dime cuál quieres.','models.demo':'Ver plantilla',
'models.cv.title':'CV — sobrio & pro','models.cv.desc':'Ideal para candidaturas o perfil profesional.','models.port.title':'Portafolio — creativo','models.port.desc':'Perfecto para artistas & diseñadores.','models.vit.title':'Escaparate — negocio','models.vit.desc':'Para empresas & freelancers.',
'pricing.h2':'🧾 Planes EternaWeb','pricing.sub':'CV & mini sitios escaparate — hosting incluido',
'pricing.card1.title':'🌿 Esencial – 49 €','pricing.card1.li1':'CV en línea simple (1 página)','pricing.card1.li2':'Personalización con datos + foto','pricing.card1.li3':'Diseño elegante & responsive','pricing.card1.li4':'Entrega en 48 h','pricing.card1.note':'Ideal para: candidaturas',
'pricing.card2.title':'✨ Escaparate – 89 €','pricing.card2.li1':'Mini sitio (2–3 páginas)','pricing.card2.li2':'Inicio + productos/servicios','pricing.card2.li3':'Botones WhatsApp, PayPal, redes','pricing.card2.li4':'Diseño armonioso & responsive','pricing.card2.note':'Ideal para: artesanos, freelancers',
...
'brief.h2':'Il tuo sito in 3 passi','brief.li1':'Scegli un pacchetto.','brief.li2':'Indica le tue preferenze (colori, stile, integrazioni).','brief.li3':'Creo e ti invio una bozza rapida.',
'btn.fill':'Le tue indicazioni','btn.send':'Invia','btn.choose':'Scelgo questo piano',
...
'devis.other':'Altre richieste','devis.name':'Nome / Cognome','devis.email':'Email','devis.note':'Nessun server: si apre la tua app email con un messaggio pre-compilato.','devis.opt.cv':'CV','devis.opt.vitrine':'Vetrina','devis.opt.portfolio':'Portfolio','devis.opt.other':'Altro',
'models.h2':'🎨 Modelli pronti','models.sub':'Scegli uno stile, apri la demo e dimmi quale vuoi.','models.demo':'Vedi modello',
'models.cv.title':'CV — sobrio & pro','models.cv.desc':'Ideale per candidature o profilo professionale.','models.port.title':'Portfolio — creativo','models.port.desc':'Perfetto per artisti & designer.','models.vit.title':'Vetrina — business','models.vit.desc':'Per aziende & liberi professionisti.',
'pricing.h2':'🧾 Piani EternaWeb','pricing.sub':'CV & mini siti vetrina — hosting incluso',
'pricing.card1.title':'🌿 Essenziale – 49 €','pricing.card1.li1':'CV online semplice (1 pagina)','pricing.card1.li2':'Personalizzazione con dati + foto','pricing.card1.li3':'Design elegante & responsive','pricing.card1.li4':'Consegna entro 48 h','pricing.card1.note':'Ideale per: candidature',
'pricing.card2.title':'✨ Vetrina – 89 €','pricing.card2.li1':'Mini sito vetrina (2–3 pagine)','pricing.card2.li2':'Home + presentazione prodotti/servizi','pricing.card2.li3':'Bottoni WhatsApp, PayPal, social','pricing.card2.li4':'Design armonioso & responsive','pricing.card2.note':'Ideale per: artigiani, freelance',
'pricing.card3.title':'💎 Premium – 129 €','pricing.card3.li1':'Tutto del piano Vetrina','pricing.card3.li2':'Creazione/redesign logo','pricing.card3.li3':'Consulenza branding','pricing.card3.li4':'SEO base + Galleria/FAQ','pricing.card3.note':'Ideale per: un lancio completo',
